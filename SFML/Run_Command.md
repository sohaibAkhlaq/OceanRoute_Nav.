...
# Current
g++ SFML.cpp -I SFML/include -L SFML/lib -o app.exe -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lsfml-network;$env:PATH = "$PWD\SFML\lib;" + $env:PATH; ./app.exe
